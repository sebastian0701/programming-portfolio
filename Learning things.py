...
def main_boolean():
	...
	print "test xor(True, True): ", xsame(True, True)
	print "test xor(True, False): ", xsame(True, False)
	print "test xor(False, True): ", xsame(False, True)
	print "test xor(False, False): ", xsame(False, False)
...
def main_conditionals():
	...
	print "test food_tax(12.45, True): ", food_tax(12.45, True)
	print "test food_tax(12.45, False): ", food_tax(12.45, False)
...
def concatenate(garfield, tony):
		return garfield+tony
...
def main_lists():
	...
	b = ['Obama', 'Will-i-am', 'seinfield',  'Elmo', 'Weird-Al']
	hit = ['Brett', 'Conner', 'Dakota', 'Jeff', 'Jacob', 'Jarod', 'Kincade', 'Chandler']
...
def main_sequence_loops():
	...
	print "testing list_total(classiqs): ", list_total(class_iqs)
	...
	print "testing sting_digit_count('R2-D2'): ", string_digit_count('R2-D2')
